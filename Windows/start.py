...
from Windows.wi_transfer import WindowInputTransaction
...
class WindowStart(Window):
    ...
    def vis(self):
        ...
        create_label_and_button(self.window, "Dodaj nowy przelew", "Nowy przelew", lambda: self.win_ic_close(WindowInputTransaction, "Wprowadź nowy przelew"))
